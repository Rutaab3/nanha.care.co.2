                    ...
                    <form method="POST" action="{{ route('onboarding.shop-owner') }}" enctype="multipart/form-data">
                        ...
                        <div id="step-1">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn px-4" id="step1-next" style="background-color: var(--sky-blue); color: var(--white); font-weight: 600;" onclick="goToStep(2)">
                        ...
                        <div id="step-2" style="display: none;">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn px-4" style="background-color: var(--sky-blue); color: var(--white); font-weight: 600;">
